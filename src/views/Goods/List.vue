					...
					<template slot-scope="scope">
						<div class="goods">
							...
							<div class="name">
								...
								<br />
								<span>商品货号：{{scope.row.goods_sn}}</span>
							</div>
						</div>
					</template>
				</el-table-column>
				<el-table-column sortable prop="retail_price" label="价格">
				</el-table-column>
				<el-table-column sortable prop="goods_number" label="库存">
				</el-table-column>
...
<script>
	...
	export default {
		...
		methods: {
			async loadGoodsList() {
				let { errno, data, total } = await Goods.list({
